...
/**
 * Notes settings creation attributes, omitting id, because it's generated by database, omitting cover, because it should be generated afterinsertion of the note
 */
